          ...
          <table id="forum_main" cellspacing="1">
            ...
            <tbody>
              <tr>
                ...
                <td class="forum_description"><a href="/forums/board/Java" class="forumtitle">Java编程和Java企业应用</a><br/>Java编程、Java Web开发、Java企业应用、Java设计模式、Java开源框架、Java应用服务器<br/></td>
              ...
              <tr>
                <td class="read_forum"></td>
                <td class="forum_description"><a href="/forums/board/web" class="forumtitle">Web前端技术：AJAX和RIA</a><br/>JavaScript编程、AJAX开发、UI界面设计、CSS、RIA技术 <br/></td>
              ...
              <tr>
                <td class="read_forum"></td>
                <td class="forum_description"><a href="/forums/board/mobile" class="forumtitle">移动编程和手机应用开发</a><br/>智能手机和上网本，移动应用平台领域的开发和应用 <br/></td>
              ...
              <tr>
                <td class="read_forum"></td>
                <td class="forum_description"><a href="/forums/board/Python" class="forumtitle">Python</a><br/><br/></td>
